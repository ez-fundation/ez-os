# EZ-OS: Documento Fundador (Consolidação v1.0-FINAL)
...
## 3. Arquitetura do Core Congelado
O núcleo é composto por domínios isolados:
- **UI (TUI)**: Renderização simbólica em terminal.
- **Memória**: Grafo factual em JSON.
- **Governança**: Validação e limites rígidos.
- **Execução**: Launcher mínimo para integração.
